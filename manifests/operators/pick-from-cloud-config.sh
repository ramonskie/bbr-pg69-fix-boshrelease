...
# The base manifests/fakepackage.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/fakepackage.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
